...
public class RakString : IDisposable {
  ...
  public static RakString FormatForPOST(RakString uri, RakString contentType, RakString body, RakString extraHeaders) {
    RakString ret = new RakString(RakNetPINVOKE.RakString_FormatForPOST__SWIG_0(RakString.getCPtr(uri), RakString.getCPtr(contentType), RakString.getCPtr(body), RakString.getCPtr(extraHeaders)), true);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static RakString FormatForPOST(RakString uri, RakString contentType, RakString body) {
    RakString ret = new RakString(RakNetPINVOKE.RakString_FormatForPOST__SWIG_1(RakString.getCPtr(uri), RakString.getCPtr(contentType), RakString.getCPtr(body)), true);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static RakString FormatForPUT(RakString uri, RakString contentType, RakString body, RakString extraHeaders) {
    RakString ret = new RakString(RakNetPINVOKE.RakString_FormatForPUT__SWIG_0(RakString.getCPtr(uri), RakString.getCPtr(contentType), RakString.getCPtr(body), RakString.getCPtr(extraHeaders)), true);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static RakString FormatForPUT(RakString uri, RakString contentType, RakString body) {
    RakString ret = new RakString(RakNetPINVOKE.RakString_FormatForPUT__SWIG_1(RakString.getCPtr(uri), RakString.getCPtr(contentType), RakString.getCPtr(body)), true);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static RakString FormatForGET(RakString uri) {
    RakString ret = new RakString(RakNetPINVOKE.RakString_FormatForGET__SWIG_1(RakString.getCPtr(uri)), true);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static RakString FormatForDELETE(RakString uri, RakString extraHeaders) {
    RakString ret = new RakString(RakNetPINVOKE.RakString_FormatForDELETE__SWIG_0(RakString.getCPtr(uri), RakString.getCPtr(extraHeaders)), true);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
